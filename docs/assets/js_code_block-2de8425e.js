...
JSON.stringify(obj)`;return(e,o)=>(openBlock(),createElementBlock("div",_hoisted_1,[_hoisted_2,_hoisted_3,createBaseVNode("p",null,[createVNode(unref(Ot),{class:"not-prose",hljs:unref(HighlightJS),code:codet,lang:"html"},null,8,["hljs"])]),_hoisted_4,createBaseVNode("p",null,[createVNode(unref(Ot),{class:"not-prose",hljs:unref(HighlightJS),code:codes,lang:"typescript"},null,8,["hljs"])]),_hoisted_5,createBaseVNode("p",_hoisted_6,[createVNode(unref(XB),{code,"on-run":onRun,hljs:unref(HighlightJS)},null,8,["hljs"])])]))}});export{_sfc_main as default};
