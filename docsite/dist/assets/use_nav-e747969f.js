...
return '<pre>'+JSON.stringify(payload, null, "  ")+'</pre>'`;return(k,y)=>(i(),u("div",m,[v,g,f,b,e("p",null,[p(o(_),{hljs:o(h),code:s,transpile:o(t.transpile)},null,8,["hljs","transpile"])]),N,T]))}});export{D as default};
