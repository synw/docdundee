<template>
  <dispatch-route :nav="nav" :hljs="hljs" :url="url">
    <template #docstring="slotProps">
      <render-py-docstring lang="python" :hljs="hljs" :py="py" v-if="slotProps.data.hasDocstring === true"
        class="max-w-[105ch]" :docstring="slotProps.data.docstring" :title="slotProps.data.name">
