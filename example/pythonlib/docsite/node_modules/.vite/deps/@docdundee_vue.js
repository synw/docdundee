import {
  ...
  withKeys,
  withModifiers
} from "./chunk-HJ4FKOB2.js";
import "./chunk-7FP5O474.js";

// node_modules/@docdundee/vue/dist/vue.mjs
var Cr = (n) => (pushScopeId("data-v-a9e8c92d"), n = n(), popScopeId(), n);
var Ro = {
  key: 0,
...
var To = Cr(() => createBaseVNode("path", {
  fill: "currentColor",
...
var qo = Cr(() => createBaseVNode("path", {
  fill: "currentColor",
...
var Bo = { key: 1 };
var Fo = { key: 0 };
var $o = { class: "nav-item-hspace" };
var Po = ["onClick"];
var zo = { key: 1 };
var Ho = { class: "nav-item-hspace" };
var Uo = ["onClick"];
var jo = defineComponent({
  ...
  setup(n) {
    const e = n, t = ref(true);
    function r() {
      t.value = !t.value;
    }
    return onBeforeMount(() => {
      (e.startState == "all" || e.startState == "one" && e.level == 0) && (t.value = false);
    }), (s, c) => {
      var o;
      const i = resolveComponent("AutoNavNode", true);
      return openBlock(), createElementBlock("div", {
        class: normalizeClass(n.level > 0 ? ["nav-header-hspace", `navnode-${n.level}`] : [`navnode-${n.level}`])
      }, [
        createBaseVNode("button", {
          class: normalizeClass(["flex items-center w-full btn navnode-header", t.value ? ["navnode-closed"] : ["navnode-opened"]]),
          onClick: c[0] || (c[0] = (a) => r())
        }, [
          createBaseVNode("div", null, [
            t.value === true ? (openBlock(), createElementBlock("svg", Ro, Mo)) : (openBlock(), createElementBlock("svg", No, Lo))
          ]),
          createBaseVNode("div", Oo, toDisplayString(n.node.title), 1)
        ], 2),
        createBaseVNode("div", {
          ...
          (((o = n.node) == null ? void 0 : o.children) ?? []).length > 0 ? (openBlock(), createElementBlock("div", Io, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(n.node.children, (a) => (openBlock(), createElementBlock("div", null, [
              createVNode(i, {
                "on-open": n.onOpen,
                node: a,
                level: n.level + 1,
            ...
            (n.node.content ?? []).length > 0 ? (openBlock(), createElementBlock("div", Fo, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(n.node.content, (a) => (openBlock(), createElementBlock("div", $o, [
                createBaseVNode("button", {
                  class: "py-1 focus:ring-0 btn navnode-item navnode-md",
                  onClick: (l) => n.onOpen(a.url)
                }, toDisplayString(a.title), 9, Po)
              ]))), 256))
            ])) : createCommentVNode("", true),
            (n.node.docstrings ?? []).length > 0 ? (openBlock(), createElementBlock("div", zo, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(n.node.docstrings, (a) => (openBlock(), createElementBlock("div", Ho, [
                createBaseVNode("button", {
                  class: "py-1 focus:ring-0 btn navnode-item navnode-docstring",
                  onClick: (l) => n.onOpen(a.url)
                }, toDisplayString(a.name), 9, Uo)
              ]))), 256))
            ])) : createCommentVNode("", true)
          ]))
        ], 2)
...
var Go = Sr(jo, [["__scopeId", "data-v-a9e8c92d"]]);
var Vo = { class: "flex flex-col" };
var a7 = defineComponent({
  ...
  setup(n) {
    return (e, t) => (openBlock(), createElementBlock("div", Vo, [
      (openBlock(true), createElementBlock(Fragment, null, renderList(n.nodes, (r) => (openBlock(), createElementBlock("div", null, [
        createVNode(Go, {
          node: r,
          "start-state": n.startState,
          "on-open": n.onOpen
...
var Zo = ["innerHTML", "onClick"];
var Ko = ["innerHTML", "onClick"];
var l7 = defineComponent({
  ...
  setup(n) {
    ...
    return (r, s) => (openBlock(), createElementBlock("div", null, [
      n.node.content.length > 0 ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList(n.node.content, (c) => (openBlock(), createElementBlock("div", null, [
        createBaseVNode("button", {
      ...
      n.node.docstrings.length > 0 ? (openBlock(true), createElementBlock(Fragment, { key: 1 }, renderList(n.node.docstrings, (c) => (openBlock(), createElementBlock("div", null, [
        createBaseVNode("button", {
...
var nt = /[!-#%-\*,-\/:;\?@\[-\]_\{\}\xA1\xA7\xAB\xB6\xB7\xBB\xBF\u037E\u0387\u055A-\u055F\u0589\u058A\u05BE\u05C0\u05C3\u05C6\u05F3\u05F4\u0609\u060A\u060C\u060D\u061B\u061E\u061F\u066A-\u066D\u06D4\u0700-\u070D\u07F7-\u07F9\u0830-\u083E\u085E\u0964\u0965\u0970\u09FD\u0A76\u0AF0\u0C84\u0DF4\u0E4F\u0E5A\u0E5B\u0F04-\u0F12\u0F14\u0F3A-\u0F3D\u0F85\u0FD0-\u0FD4\u0FD9\u0FDA\u104A-\u104F\u10FB\u1360-\u1368\u1400\u166D\u166E\u169B\u169C\u16EB-\u16ED\u1735\u1736\u17D4-\u17D6\u17D8-\u17DA\u1800-\u180A\u1944\u1945\u1A1E\u1A1F\u1AA0-\u1AA6\u1AA8-\u1AAD\u1B5A-\u1B60\u1BFC-\u1BFF\u1C3B-\u1C3F\u1C7E\u1C7F\u1CC0-\u1CC7\u1CD3\u2010-\u2027\u2030-\u2043\u2045-\u2051\u2053-\u205E\u207D\u207E\u208D\u208E\u2308-\u230B\u2329\u232A\u2768-\u2775\u27C5\u27C6\u27E6-\u27EF\u2983-\u2998\u29D8-\u29DB\u29FC\u29FD\u2CF9-\u2CFC\u2CFE\u2CFF\u2D70\u2E00-\u2E2E\u2E30-\u2E4E\u3001-\u3003\u3008-\u3011\u3014-\u301F\u3030\u303D\u30A0\u30FB\uA4FE\uA4FF\uA60D-\uA60F\uA673\uA67E\uA6F2-\uA6F7\uA874-\uA877\uA8CE\uA8CF\uA8F8-\uA8FA\uA8FC\uA92E\uA92F\uA95F\uA9C1-\uA9CD\uA9DE\uA9DF\uAA5C-\uAA5F\uAADE\uAADF\uAAF0\uAAF1\uABEB\uFD3E\uFD3F\uFE10-\uFE19\uFE30-\uFE52\uFE54-\uFE61\uFE63\uFE68\uFE6A\uFE6B\uFF01-\uFF03\uFF05-\uFF0A\uFF0C-\uFF0F\uFF1A\uFF1B\uFF1F\uFF20\uFF3B-\uFF3D\uFF3F\uFF5B\uFF5D\uFF5F-\uFF65]|\uD800[\uDD00-\uDD02\uDF9F\uDFD0]|\uD801\uDD6F|\uD802[\uDC57\uDD1F\uDD3F\uDE50-\uDE58\uDE7F\uDEF0-\uDEF6\uDF39-\uDF3F\uDF99-\uDF9C]|\uD803[\uDF55-\uDF59]|\uD804[\uDC47-\uDC4D\uDCBB\uDCBC\uDCBE-\uDCC1\uDD40-\uDD43\uDD74\uDD75\uDDC5-\uDDC8\uDDCD\uDDDB\uDDDD-\uDDDF\uDE38-\uDE3D\uDEA9]|\uD805[\uDC4B-\uDC4F\uDC5B\uDC5D\uDCC6\uDDC1-\uDDD7\uDE41-\uDE43\uDE60-\uDE6C\uDF3C-\uDF3E]|\uD806[\uDC3B\uDE3F-\uDE46\uDE9A-\uDE9C\uDE9E-\uDEA2]|\uD807[\uDC41-\uDC45\uDC70\uDC71\uDEF7\uDEF8]|\uD809[\uDC70-\uDC74]|\uD81A[\uDE6E\uDE6F\uDEF5\uDF37-\uDF3B\uDF44]|\uD81B[\uDE97-\uDE9A]|\uD82F\uDC9F|\uD836[\uDE87-\uDE8B]|\uD83A[\uDD5E\uDD5F]/;
var Ie = {};
var vt = {};
function mF(n) {
  var e, t, r = vt[n];
...
function dn(n, e, t) {
  var r, s, c, i, o, a = "";
  for (typeof e != "string" && (t = e, e = dn.defaultChars), typeof t > "u" && (t = true), o = mF(e), r = 0, s = n.length; r < s; r++) {
...
var yt = ["/", "?", "#"];
var RF = 255;
var Et = /^[+a-z0-9A-Z_-]{0,63}$/;
var TF = /^([+a-z0-9A-Z_-]{0,63})(.*)$/;
var wt = {
  javascript: true,
  "javascript:": true
};
...
sn.prototype.parse = function(n, e) {
  ...
  var l = EF.exec(o);
  if (l && (l = l[0], s = l.toLowerCase(), this.protocol = l, o = o.substr(l.length)), (e || l || o.match(/^\/\/[^@\/]+@[^@\/]+/)) && (i = o.substr(0, 2) === "//", i && !(l && wt[l]) && (o = o.substr(2), this.slashes = true)), !wt[l] && (i || l && !At[l])) {
    var u = -1;
...
var IF = function(e, t, r) {
  ...
  if (e.charCodeAt(t) === 60) {
    for (t++; t < r; ) {
      if (s = e.charCodeAt(t), s === 10 || s === 60)
        return a;
      if (s === 62)
        return a.pos = t + 1, a.str = Mt(e.slice(o + 1, t)), a.ok = true, a;
      if (s === 92 && t + 1 < r) {
        t += 2;
        continue;
      }
  ...
  return o === t || c !== 0 || (a.str = Mt(e.slice(o, t)), a.lines = i, a.pos = t, a.ok = true), a;
};
var BF = H.unescapeAll;
var FF = function(e, t, r) {
  ...
  for (t++, c === 40 && (c = 41); t < r; ) {
    if (s = e.charCodeAt(t), s === c)
      return a.pos = t + 1, a.lines = i, a.str = BF(e.slice(o + 1, t)), a.ok = true, a;
    if (s === 40 && c === 41)
      return a;
...
Be.prototype.renderToken = function(e, t, r) {
  var s, c = "", i = false, o = e[t];
  return o.hidden ? "" : (o.block && o.nesting !== -1 && t && e[t - 1].hidden && (c += `
`), c += (o.nesting === -1 ? "</" : "<") + o.tag, c += this.renderAttrs(o), o.nesting === 0 && r.xhtmlOut && (c += " /"), o.block && (i = true, o.nesting === 1 && t + 1 < e.length && (s = e[t + 1], (s.type === "inline" || s.hidden || s.nesting === -1 && s.tag === o.tag) && (i = false))), c += i ? `>
` : ">", c);
};
...
le.prototype.enable = function(n, e) {
  ...
  return n.forEach(function(r) {
    ...
    this.__rules__[s].enabled = true, t.push(r);
...
le.prototype.disable = function(n, e) {
  ...
  return n.forEach(function(r) {
    ...
    this.__rules__[s].enabled = false, t.push(r);
  }, this), this.__cache__ = null, t;
};
...
var Nt = H.isWhiteSpace;
var qt = H.isPunctChar;
var Lt = H.isMdAsciiPunct;
var o$ = /['"]/;
var Ot = /['"]/g;
var It = "’";
function Xe(n, e, t) {
  ...
  for (N = [], t = 0; t < n.length; t++) {
    ...
    e:
      for (; i < o && (Ot.lastIndex = i, c = Ot.exec(s), !!c); ) {
        if (R = A = true, i = c.index + 1, S = c[0] === "'", u = 32, c.index - 1 >= 0)
        ...
        if (p = Lt(u) || qt(String.fromCharCode(u)), h = Lt(d) || qt(String.fromCharCode(d)), m = Nt(u), v = Nt(d), v ? R = false : h && (m || p || (R = false)), m ? A = false : p && (v || h || (A = false)), d === 34 && c[0] === '"' && u >= 48 && u <= 57 && (A = R = false), R && A && (R = p, A = h), !R && !A) {
...
function Bt(n) {
  var e = [], t = 0, r = n.length, s, c = false, i = 0, o = "";
...
var p$ = function(e, t, r, s) {
  ...
  for (h = e.push("tr_close", "tr", -1), h = e.push("thead_close", "thead", -1), u = t + 2; u < r && !(e.sCount[u] < e.blkIndent); u++) {
    for (S = false, a = 0, l = N.length; a < l; a++)
      if (N[a](e, u, r, true)) {
        S = true;
        break;
      }
  ...
  return A && (h = e.push("tbody_close", "tbody", -1), A[1] = u), h = e.push("table_close", "table", -1), R[1] = u, e.parentType = w, e.line = u, true;
};
var h$ = function(e, t, r) {
  ...
  return e.line = c, i = e.push("code_block", "code", 0), i.content = e.getLines(t, c, 4 + e.blkIndent, false) + `
`, i.map = [t, e.line], true;
};
var d$ = function(e, t, r, s) {
  var c, i, o, a, l, u, d, p = false, h = e.bMarks[t] + e.tShift[t], m = e.eMarks[t];
  ...
  return i = e.sCount[t], e.line = a + (p ? 1 : 0), u = e.push("fence", "code", 0), u.info = o, u.content = e.getLines(t + 1, a, i, true), u.markup = d, u.map = [t, e.line], true;
};
var Ft = H.isSpace;
var g$ = function(e, t, r, s) {
  ...
  if (s)
    return true;
  for (a = h = e.sCount[t] + 1, e.src.charCodeAt(B) === 32 ? (B++, a++, h++, c = false, N = true) : e.src.charCodeAt(B) === 9 ? (N = true, (e.bsCount[t] + h) % 4 === 3 ? (B++, a++, h++, c = false) : c = true) : N = false, m = [e.bMarks[t]], e.bMarks[t] = B; B < U && (i = e.src.charCodeAt(B), Ft(i)); ) {
  ...
  for (v = [e.bsCount[t]], e.bsCount[t] = e.sCount[t] + 1 + (N ? 1 : 0), u = B >= U, w = [e.sCount[t]], e.sCount[t] = h - a, S = [e.tShift[t]], e.tShift[t] = B - e.bMarks[t], C = e.md.block.ruler.getRules("blockquote"), A = e.parentType, e.parentType = "blockquote", p = t + 1; p < r && (K = e.sCount[p] < e.blkIndent, B = e.bMarks[p] + e.tShift[p], U = e.eMarks[p], !(B >= U)); p++) {
    if (e.src.charCodeAt(B++) === 62 && !K) {
      for (a = h = e.sCount[p] + 1, e.src.charCodeAt(B) === 32 ? (B++, a++, h++, c = false, N = true) : e.src.charCodeAt(B) === 9 ? (N = true, (e.bsCount[p] + h) % 4 === 3 ? (B++, a++, h++, c = false) : c = true) : N = false, m.push(e.bMarks[p]), e.bMarks[p] = B; B < U && (i = e.src.charCodeAt(B), Ft(i)); ) {
    ...
    if (u)
      break;
    for (O = false, o = 0, l = C.length; o < l; o++)
      if (C[o](e, p, r, true)) {
        O = true;
        break;
      }
...
var _$ = function(e, t, r, s) {
  ...
  return i < 3 ? false : (s || (e.line = t + 1, a = e.push("hr", "hr", 0), a.map = [t, e.line], a.markup = Array(i + 1).join(String.fromCharCode(c))), true);
};
var qr = H.isSpace;
function $t(n, e) {
  var t, r, s, c;
...
function m$(n, e) {
  ...
  for (t = e + 2, r = n.tokens.length - 2; t < r; t++)
    n.tokens[t].level === s && n.tokens[t].type === "paragraph_open" && (n.tokens[t + 2].hidden = true, n.tokens[t].hidden = true, t += 2);
}
var v$ = function(e, t, r, s) {
  var c, i, o, a, l, u, d, p, h, m, v, R, A, w, S, N, O, C, P, K, V, B, U, ce, re, k, j, f, b = false, y = true;
  if (e.sCount[t] - e.blkIndent >= 4 || e.listIndent >= 0 && e.sCount[t] - e.listIndent >= 4 && e.sCount[t] < e.blkIndent)
    return false;
  if (s && e.parentType === "paragraph" && e.sCount[t] >= e.blkIndent && (b = true), (U = Pt(e, t)) >= 0) {
    if (d = true, re = e.bMarks[t] + e.tShift[t], A = Number(e.src.slice(re, U - 1)), b && A !== 1)
      return false;
  } else if ((U = $t(e, t)) >= 0)
    d = false;
  else
  ...
  if (R = e.src.charCodeAt(U - 1), s)
    return true;
  for (v = e.tokens.length, d ? (f = e.push("ordered_list_open", "ol", 1), A !== 1 && (f.attrs = [["start", A]])) : f = e.push("bullet_list_open", "ul", 1), f.map = m = [t, 0], f.markup = String.fromCharCode(R), S = t, ce = false, j = e.md.block.ruler.getRules("list"), C = e.parentType, e.parentType = "list"; S < r; ) {
    ...
    if (i = B, i >= w ? l = 1 : l = N - u, l > 4 && (l = 1), a = u + l, f = e.push("list_item_open", "li", 1), f.markup = String.fromCharCode(R), f.map = p = [t, 0], d && (f.info = e.src.slice(re, U - 1)), V = e.tight, K = e.tShift[t], P = e.sCount[t], O = e.listIndent, e.listIndent = e.blkIndent, e.blkIndent = a, e.tight = true, e.tShift[t] = i - e.bMarks[t], e.sCount[t] = N, i >= w && e.isEmpty(t + 1) ? e.line = Math.min(e.line + 2, r) : e.md.block.tokenize(e, t, r, true), (!e.tight || ce) && (y = false), ce = e.line - t > 1 && e.isEmpty(e.line - 1), e.blkIndent = e.listIndent, e.listIndent = O, e.tShift[t] = K, e.sCount[t] = P, e.tight = V, f = e.push("list_item_close", "li", -1), f.markup = String.fromCharCode(R), S = t = e.line, p[1] = S, i = e.bMarks[t], S >= r || e.sCount[S] < e.blkIndent || e.sCount[t] - e.blkIndent >= 4)
      break;
    for (k = false, o = 0, h = j.length; o < h; o++)
      if (j[o](e, S, r, true)) {
        k = true;
        break;
      }
  ...
  return d ? f = e.push("ordered_list_close", "ol", -1) : f = e.push("bullet_list_close", "ul", -1), f.markup = String.fromCharCode(R), m[1] = S, e.line = S, e.parentType = C, y && m$(e, v), true;
};
var x$ = H.normalizeReference;
var Qe = H.isSpace;
var k$ = function(e, t, r, s) {
  ...
  for (a = e.lineMax, S = e.md.block.ruler.getRules("reference"), m = e.parentType, e.parentType = "reference"; K < a && !e.isEmpty(K); K++)
    if (!(e.sCount[K] - e.blkIndent > 3) && !(e.sCount[K] < 0)) {
      for (w = false, u = 0, d = S.length; u < d; u++)
        if (S[u](e, K, a, true)) {
          w = true;
          break;
        }
  ...
  for (A = e.getLines(t, K, e.blkIndent, false).trim(), P = A.length, C = 1; C < P; C++) {
  ...
  if (C < P && A.charCodeAt(C) !== 10 && N)
    for (N = "", C = i, O = o; C < P && (c = A.charCodeAt(C), !!Qe(c)); )
      C++;
  return C < P && A.charCodeAt(C) !== 10 || (p = x$(A.slice(1, h)), !p) ? false : (s || (typeof e.env.references > "u" && (e.env.references = {}), typeof e.env.references[p] > "u" && (e.env.references[p] = { title: N, href: l }), e.parentType = m, e.line = t + O + 1), true);
};
var y$ = [
  "address",
  "article",
...
var _n = {};
var E$ = "[a-zA-Z_:][a-zA-Z0-9:._-]*";
var w$ = "[^\"'=<>`\\x00-\\x20]+";
var A$ = "'[^']*'";
var C$ = '"[^"]*"';
var S$ = "(?:" + w$ + "|" + A$ + "|" + C$ + ")";
var D$ = "(?:\\s+" + E$ + "(?:\\s*=\\s*" + S$ + ")?)";
var Lr = "<[A-Za-z][A-Za-z0-9\\-]*" + D$ + "*\\s*\\/?>";
var Or = "<\\/[A-Za-z][A-Za-z0-9\\-]*\\s*>";
var R$ = "<!---->|<!--(?:-?[^>-])(?:-?[^-])*-->";
var T$ = "<[?][\\s\\S]*?[?]>";
var M$ = "<![A-Z]+\\s+[^>]*>";
var N$ = "<!\\[CDATA\\[[\\s\\S]*?\\]\\]>";
var q$ = new RegExp("^(?:" + Lr + "|" + Or + "|" + R$ + "|" + T$ + "|" + M$ + "|" + N$ + ")");
var L$ = new RegExp("^(?:" + Lr + "|" + Or + ")");
_n.HTML_TAG_RE = q$;
_n.HTML_OPEN_CLOSE_TAG_RE = L$;
var O$ = y$;
var I$ = _n.HTML_OPEN_CLOSE_TAG_RE;
var Ne = [
  ...
  [/^<![A-Z]/, />/, true],
  [/^<!\[CDATA\[/, /\]\]>/, true],
  [new RegExp("^</?(" + O$.join("|") + ")(?=(\\s|/?>|$))", "i"), /^$/, true],
  [new RegExp(I$.source + "\\s*$"), /^$/, false]
];
var B$ = function(e, t, r, s) {
  ...
  return e.line = i, o = e.push("html_block", "", 0), o.map = [t, i], o.content = e.getLines(t, i, e.blkIndent, true), true;
};
var zt = H.isSpace;
...
var $$ = function(e, t, r) {
  ...
  for (m = e.parentType, e.parentType = "paragraph"; h < r && !e.isEmpty(h); h++)
    if (!(e.sCount[h] - e.blkIndent > 3)) {
      ...
      if (!(e.sCount[h] < 0)) {
        for (c = false, i = 0, o = v.length; i < o; i++)
          if (v[i](e, h, r, true)) {
            c = true;
            break;
          }
  ...
  return d ? (s = e.getLines(t, h, e.blkIndent, false).trim(), e.line = h + 1, a = e.push("heading_open", "h" + String(d), 1), a.markup = String.fromCharCode(p), a.map = [t, e.line], a = e.push("inline", "", 0), a.content = s, a.map = [t, e.line - 1], a.children = [], a = e.push("heading_close", "h" + String(d), -1), a.markup = String.fromCharCode(p), e.parentType = m, true) : false;
};
var P$ = function(e, t) {
  ...
  for (a = e.parentType, e.parentType = "paragraph"; l < d && !e.isEmpty(l); l++)
    if (!(e.sCount[l] - e.blkIndent > 3) && !(e.sCount[l] < 0)) {
      for (s = false, c = 0, i = u.length; c < i; c++)
        if (u[c](e, l, d, true)) {
          s = true;
          break;
        }
  ...
  return r = e.getLines(t, l, e.blkIndent, false).trim(), e.line = l, o = e.push("paragraph_open", "p", 1), o.map = [t, e.line], o = e.push("inline", "", 0), o.content = r, o.map = [t, e.line], o.children = [], o = e.push("paragraph_close", "p", -1), e.parentType = a, true;
};
var Ir = rt;
var mn = H.isSpace;
function fe(n, e, t, r) {
  var s, c, i, o, a, l, u, d;
  for (this.src = n, this.md = e, this.env = t, this.tokens = r, this.bMarks = [], this.eMarks = [], this.tShift = [], this.sCount = [], this.bsCount = [], this.blkIndent = 0, this.line = 0, this.lineMax = 0, this.tight = false, this.ddIndent = -1, this.listIndent = -1, this.parentType = "root", this.level = 0, this.result = "", c = this.src, d = false, i = o = l = u = 0, a = c.length; o < a; o++) {
    if (s = c.charCodeAt(o), !d)
      if (mn(s)) {
        ...
        d = true;
    (s === 10 || o === a - 1) && (s !== 10 && o++, this.bMarks.push(i), this.eMarks.push(o), this.tShift.push(l), this.sCount.push(u), this.bsCount.push(0), d = false, l = 0, u = 0, i = o + 1);
  }
...
vn.prototype.tokenize = function(n, e, t) {
  for (var r, s, c = this.ruler.getRules(""), i = c.length, o = e, a = false, l = n.md.options.maxNesting; o < t && (n.line = o = n.skipEmptyLines(o), !(o >= t || n.sCount[o] < n.blkIndent)); ) {
    if (n.level >= l) {
      n.line = t;
      break;
    }
    for (s = 0; s < i && (r = c[s](n, o, t, false), !r); s++)
      ;
    n.tight = !a, n.isEmpty(n.line - 1) && (a = true), o = n.line, o < t && n.isEmpty(o) && (a = true, o++, n.line = o);
  }
};
...
var V$ = /(?:^|[^a-z0-9.+-])([a-z][a-z0-9.+-]*)$/i;
var Z$ = function(e, t) {
  var r, s, c, i, o, a, l, u;
  return !e.md.options.linkify || e.linkLevel > 0 || (r = e.pos, s = e.posMax, r + 3 > s) || e.src.charCodeAt(r) !== 58 || e.src.charCodeAt(r + 1) !== 47 || e.src.charCodeAt(r + 2) !== 47 || (c = e.pending.match(V$), !c) || (i = c[1], o = e.md.linkify.matchAtStart(e.src.slice(r - i.length)), !o) || (a = o.url, a = a.replace(/\*+$/, ""), l = e.md.normalizeLink(a), !e.md.validateLink(l)) ? false : (t || (e.pending = e.pending.slice(0, -i.length), u = e.push("link_open", "a", 1), u.attrs = [["href", l]], u.markup = "linkify", u.info = "auto", u = e.push("text", "", 0), u.content = e.md.normalizeLinkText(a), u = e.push("link_close", "a", -1), u.markup = "linkify", u.info = "auto"), e.pos += a.length - i.length, true);
};
var K$ = H.isSpace;
var W$ = function(e, t) {
  var r, s, c, i = e.pos;
...
var J$ = function(e, t) {
  ...
  return i = e.src[a], r >= 55296 && r <= 56319 && a + 1 < l && (s = e.src.charCodeAt(a + 1), s >= 56320 && s <= 57343 && (i += e.src[a + 1], a++)), c = "\\" + i, t || (o = e.push("text_special", "", 0), r < 256 && st[r] !== 0 ? o.content = i : o.content = c, o.markup = c, o.info = "escape"), e.pos = a + 1, true;
};
var X$ = function(e, t) {
  ...
  if (c = e.src.slice(r, d), l = c.length, e.backticksScanned && (e.backticks[l] || 0) <= r)
    return t || (e.pending += c), e.pos += l, true;
  ...
  return e.backticksScanned = true, t || (e.pending += c), e.pos += l, true;
};
var xn = {};
xn.tokenize = function(e, t) {
  var r, s, c, i, o, a = e.pos, l = e.src.charCodeAt(a);
  if (t || l !== 126 || (s = e.scanDelims(e.pos, true), i = s.length, o = String.fromCharCode(l), i < 2))
    return false;
...
var Q$ = H.normalizeReference;
var $n = H.isSpace;
var e8 = function(e, t) {
  var r, s, c, i, o, a, l, u, d, p = "", h = "", m = e.pos, v = e.posMax, R = e.pos, A = true;
  if (e.src.charCodeAt(e.pos) !== 91 || (o = e.pos + 1, i = e.md.helpers.parseLinkLabel(e, e.pos, true), i < 0))
    return false;
  if (a = i + 1, a < v && e.src.charCodeAt(a) === 40) {
    for (A = false, a++; a < v && (s = e.src.charCodeAt(a), !(!$n(s) && s !== 10)); a++)
      ;
    if (a >= v)
      return false;
    ...
    (a >= v || e.src.charCodeAt(a) !== 41) && (A = true), a++;
  }
  if (A) {
    ...
    if (a < v && e.src.charCodeAt(a) === 91 ? (R = a + 1, a = e.md.helpers.parseLinkLabel(e, a), a >= 0 ? c = e.src.slice(R, a++) : a = i + 1) : a = i + 1, c || (c = e.src.slice(o, i)), u = e.env.references[Q$(c)], !u)
      return e.pos = m, false;
    p = u.href, h = u.title;
  }
  return t || (e.pos = o, e.posMax = i, d = e.push("link_open", "a", 1), d.attrs = r = [["href", p]], h && r.push(["title", h]), e.linkLevel++, e.md.inline.tokenize(e), e.linkLevel--, d = e.push("link_close", "a", -1)), e.pos = a, e.posMax = v, true;
};
var n8 = H.normalizeReference;
var Pn = H.isSpace;
var t8 = function(e, t) {
  var r, s, c, i, o, a, l, u, d, p, h, m, v, R = "", A = e.pos, w = e.posMax;
  if (e.src.charCodeAt(e.pos) !== 33 || e.src.charCodeAt(e.pos + 1) !== 91 || (a = e.pos + 2, o = e.md.helpers.parseLinkLabel(e, e.pos + 1, false), o < 0))
    return false;
  ...
  return t || (c = e.src.slice(a, o), e.md.inline.parse(
    ...
    e.env,
    m = []
  ), h = e.push("image", "img", 0), h.attrs = r = [["src", R], ["alt", ""]], h.children = m, h.content = c, p && r.push(["title", p])), e.pos = l, e.posMax = w, true;
};
var r8 = /^([a-zA-Z0-9.!#$%&'*+\/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*)$/;
var o8 = /^([a-zA-Z][a-zA-Z0-9+.\-]{1,31}):([^<>\x00-\x20]*)$/;
var s8 = function(e, t) {
...
var u8 = function(e, t) {
  var r, s, c, i, o = e.pos;
  return !e.md.options.html || (c = e.posMax, e.src.charCodeAt(o) !== 60 || o + 2 >= c) || (r = e.src.charCodeAt(o + 1), r !== 33 && r !== 63 && r !== 47 && !l8(r)) || (s = e.src.slice(o).match(c8), !s) ? false : (t || (i = e.push("html_inline", "", 0), i.content = e.src.slice(o, o + s[0].length), i8(i.content) && e.linkLevel++, a8(i.content) && e.linkLevel--), e.pos += s[0].length, true);
};
var Gt = on;
var f8 = H.has;
var p8 = H.isValidEntityCode;
var Vt = H.fromCodePoint;
var h8 = /^&#((?:x[a-f0-9]{1,6}|[0-9]{1,7}));/i;
var d8 = /^&([a-z][a-z0-9]{1,31});/i;
var g8 = function(e, t) {
  ...
  if (r = e.src.charCodeAt(o + 1), r === 35) {
    if (c = e.src.slice(o).match(h8), c)
      return t || (s = c[1][0].toLowerCase() === "x" ? parseInt(c[1].slice(1), 16) : parseInt(c[1], 10), i = e.push("text_special", "", 0), i.content = p8(s) ? Vt(s) : Vt(65533), i.markup = c[0], i.info = "entity"), e.pos += c[0].length, true;
  } else if (c = e.src.slice(o).match(d8), c && f8(Gt, c[1]))
    return t || (i = e.push("text_special", "", 0), i.content = Gt[c[1]], i.markup = c[0], i.info = "entity"), e.pos += c[0].length, true;
  return false;
};
function Zt(n, e) {
    ...
    for (t = 0; t < d; t++)
      if (s = e[t], m.push(0), (e[p].marker !== s.marker || h !== s.token - 1) && (p = t), h = s.token, s.length = s.length || 0, !!s.close) {
        for (u.hasOwnProperty(s.marker) || (u[s.marker] = [-1, -1, -1, -1, -1, -1]), i = u[s.marker][(s.open ? 3 : 0) + s.length % 3], r = p - m[p] - 1, o = r; r > i; r -= m[r] + 1)
          if (c = e[r], c.marker === s.marker && c.open && c.end < 0 && (a = false, (c.close || s.open) && (c.length + s.length) % 3 === 0 && (c.length % 3 !== 0 || s.length % 3 !== 0) && (a = true), !a)) {
            l = r > 0 && !e[r - 1].open ? m[r - 1] + 1 : 0, m[t] = t - r + l, m[r] = l, s.open = false, c.end = t, c.close = false, o = -1, h = -2;
            break;
          }
...
var ct = rt;
var Kt = H.isWhiteSpace;
var Wt = H.isPunctChar;
var Yt = H.isMdAsciiPunct;
function Ye(n, e, t, r) {
...
Ye.prototype.scanDelims = function(n, e) {
  var t = n, r, s, c, i, o, a, l, u, d, p = true, h = true, m = this.posMax, v = this.src.charCodeAt(n);
  for (r = n > 0 ? this.src.charCodeAt(n - 1) : 32; t < m && this.src.charCodeAt(t) === v; )
    t++;
  return c = t - n, s = t < m ? this.src.charCodeAt(t) : 32, l = Yt(r) || Wt(String.fromCharCode(r)), d = Yt(s) || Wt(String.fromCharCode(s)), a = Kt(r), u = Kt(s), u ? p = false : d && (a || l || (p = false)), a ? h = false : l && (u || d || (h = false)), e ? (i = p, o = h) : (i = p && (!h || l), o = h && (!p || d)), {
    can_open: i,
    can_close: o,
    length: c
  };
...
Je.prototype.skipToken = function(n) {
  ...
  if (n.level < i)
    for (t = 0; t < c && (n.level++, e = s[t](n, true), n.level--, !e); t++)
      ;
  else
    n.pos = n.posMax;
  e || n.pos++, o[r] = n.pos;
...
var S8 = "a[cdefgilmnoqrstuwxz]|b[abdefghijmnorstvwyz]|c[acdfghiklmnoruvwxyz]|d[ejkmoz]|e[cegrstu]|f[ijkmor]|g[abdefghilmnpqrstuwy]|h[kmnrtu]|i[delmnoqrst]|j[emop]|k[eghimnprwyz]|l[abcikrstuvy]|m[acdeghklmnopqrstuvwxyz]|n[acefgilopruz]|om|p[aefghklmnrstwy]|qa|r[eosuw]|s[abcdeghijklmnortuvxyz]|t[cdfghjklmnortvwz]|u[agksyz]|v[aceginu]|w[fs]|y[et]|z[amw]";
var D8 = "biz|com|edu|gov|net|org|pro|web|xxx|aero|asia|coop|info|museum|name|shop|рф".split("|");
function R8(n) {
...
function te(n, e) {
  if (!(this instanceof te))
    return new te(n, e);
  e || A8(n) && (e = n, n = {}), this.__opts__ = Wn({}, Br, e), this.__index__ = -1, this.__last_index__ = -1, this.__schema__ = "", this.__text_cache__ = "", this.__schemas__ = Wn({}, C8, n), this.__compiled__ = {}, this.__tlds__ = D8, this.__tlds_replaced__ = false, this.re = {}, cn(this);
}
...
var N8 = te;
var q8 = {};
var L8 = Object.freeze(Object.defineProperty({
  __proto__: null,
  default: q8
...
var V8 = /^(vbscript|javascript|file|data):/;
var Z8 = /^data:image\/(gif|png|jpeg|webp);/;
function K8(n) {
  var e = n.trim().toLowerCase();
  return V8.test(e) ? !!Z8.test(e) : true;
}
var $r = ["http:", "https:", "mailto:"];
function W8(n) {
  var e = Ae.parse(n, true);
...
se.prototype.enable = function(n, e) {
  ...
  Array.isArray(n) || (n = [n]), ["core", "block", "inline"].forEach(function(s) {
    t = t.concat(this[s].ruler.enable(n, true));
...
se.prototype.disable = function(n, e) {
  var t = [];
  Array.isArray(n) || (n = [n]), ["core", "block", "inline"].forEach(function(s) {
    t = t.concat(this[s].ruler.disable(n, true));
...
var n4 = "</span>";
var tr = (n) => !!n.scope || n.sublanguage && n.language;
var t4 = (n, { prefix: e }) => {
  if (n.includes(".")) {
    const t = n.split(".");
    return [
...
var s4 = class extends o4 {
  ...
  addSublanguage(e, t) {
    const r = e.root;
    r.sublanguage = true, r.language = t, this.add(r);
  }
  toHTML() {
...
var ft = "[a-zA-Z_]\\w*";
var Gr = "\\b\\d+(\\.\\d+)?";
var Vr = "(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)";
var Zr = "\\b(0b[01]+)";
var p4 = "!|!=|!==|%|%=|&|&&|&=|\\*|\\*=|\\+|\\+=|,|-|-=|/=|/|:|;|<<|<<=|<=|<|===|==|=|>>>=|>>=|>=|>>>|>>|>|\\?|\\[|\\{|\\(|\\^|\\^=|\\||\\|=|\\|\\||~";
var h4 = (n = {}) => {
  const e = /^#![ ]*\//;
...
var qe = (n, e) => {
  or[`${n}/${e}`] || (console.log(`Deprecated as of ${n}. ${e}`), or[`${n}/${e}`] = true);
};
var an = new Error();
function Wr(n, e, { key: t }) {
  ...
  for (let o = 1; o <= e.length; o++)
    i[o + r] = s[o], c[o + r] = true, r += Ur(e[o - 1]);
  n[t] = i, n[t]._emit = c, n[t]._multi = true;
}
function $4(n) {
...
function U4(n) {
  ...
  class t {
    ...
    compile() {
      ...
      this.matcherRe = e(ut(o, { joinWith: "|" }), true), this.lastIndex = 0;
    }
    /** @param {string} s */
    exec(o) {
  ...
  function c(i, o) {
    ...
    [
      ...
      q4
    ].forEach((u) => u(i, o)), i.isCompiled = true;
    let l = null;
    return typeof i.keywords == "object" && i.keywords.$pattern && (i.keywords = Object.assign({}, i.keywords), l = i.keywords.$pattern, delete i.keywords.$pattern), l = l || /\w+/, i.keywords && (i.keywords = Kr(i.keywords, n.case_insensitive)), a.keywordPatternRe = e(l, true), o && (i.begin || (i.begin = /\B|\b/), a.beginRe = e(a.begin), !i.end && !i.endsWithParent && (i.end = /\B|\b/), i.end && (a.endRe = e(a.end)), a.terminatorEnd = je(a.end) || "", i.endsWithParent && o.terminatorEnd && (a.terminatorEnd += (i.end ? "|" : "") + o.terminatorEnd)), i.illegal && (a.illegalRe = e(
      /** @type {RegExp | string} */
      i.illegal
...
function Yr(n) {
  return n ? n.endsWithParent || Yr(n.starts) : false;
}
function j4(n) {
...
var jn = Pr;
var cr = me;
var ir = Symbol("nomatch");
var Z4 = 7;
var K4 = function(n) {
  const e = /* @__PURE__ */ Object.create(null), t = /* @__PURE__ */ Object.create(null), r = [];
  let s = true;
  const c = "Could not find the language '{}', did you forget to load/include a language module?", i = { disableAutodetect: true, name: "Plain text", contains: [] };
  let o = {
...
https://github.com/highlightjs/highlight.js/issues/2277`), I = f, T = b), y === void 0 && (y = true);
    const Z = {
      code: T,
      language: I
    };
  ...
  function d(f, b, y, T) {
    ...
    function pe() {
      ...
      if (typeof x.subLanguage == "string") {
        ...
        g = d(x.subLanguage, L, true, He[x.subLanguage]), He[x.subLanguage] = /** @type {CompiledMode} */
        g._top;
      } else
    ...
    function Pe(g, _, E) {
      ...
      if (M) {
        if (g["on:end"]) {
          const z = new nr(g);
          g["on:end"](_, z), z.isMatchIgnored && (M = false);
        }
        if (M) {
    ...
    function An(g) {
      return x.matcher.regexIndex === 0 ? (L += g[0], 1) : (ye = true, 0);
    }
    function Cn(g) {
    ...
    Dn();
    let L = "", de = 0, ee = 0, ke = 0, ye = false;
    try {
      for (x.matcher.considerAll(); ; ) {
        ke++, ye ? ye = false : x.matcher.considerAll(), x.matcher.lastIndex = ee;
  ...
  function v(f) {
    ...
    b = f;
    const T = b.textContent, I = y ? u(T, { language: y, ignoreIllegals: true }) : h(T);
  ...
  typeof window < "u" && window.addEventListener && window.addEventListener("DOMContentLoaded", O, false);
  function C(f, b) {
    let y = null;
    try {
      y = b(n);
...
var Y4 = "</span>";
var lr = (n) => !!n.scope || n.sublanguage && n.language;
var J4 = (n, { prefix: e }) => {
  if (n.includes(".")) {
    const t = n.split(".");
    return [
...
var _t = "[a-zA-Z_]\\w*";
var no = "\\b\\d+(\\.\\d+)?";
var to = "(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)";
var ro = "\\b(0b[01]+)";
var c9 = "!|!=|!==|%|%=|&|&&|&=|\\*|\\*=|\\+|\\+=|,|-|-=|/=|/|:|;|<<|<<=|<=|<|===|==|=|>>>=|>>=|>=|>>>|>>|>|\\?|\\[|\\{|\\(|\\^|\\^=|\\||\\|=|\\|\\||~";
var i9 = (n = {}) => {
  const e = /^#![ ]*\//;
...
var Le = (n, e) => {
  fr[`${n}/${e}`] || (console.log(`Deprecated as of ${n}. ${e}`), fr[`${n}/${e}`] = true);
};
var un = new Error();
function so(n, e, { key: t }) {
  ...
  const s = n[t], c = {}, i = {};
  for (let o = 1; o <= e.length; o++)
    i[o + r] = s[o], c[o + r] = true, r += Qr(e[o - 1]);
  n[t] = i, n[t]._emit = c, n[t]._multi = true;
}
function q9(n) {
  if (Array.isArray(n.begin)) {
...
function B9(n) {
  ...
  class t {
    ...
    compile() {
      this.regexes.length === 0 && (this.exec = () => null);
      const o = this.regexes.map((a) => a[1]);
      this.matcherRe = e(bt(o, { joinWith: "|" }), true), this.lastIndex = 0;
    }
    exec(o) {
      this.matcherRe.lastIndex = this.lastIndex;
      const a = this.matcherRe.exec(o);
  ...
  function c(i, o) {
    ...
    let l = null;
    return typeof i.keywords == "object" && i.keywords.$pattern && (i.keywords = Object.assign({}, i.keywords), l = i.keywords.$pattern, delete i.keywords.$pattern), l = l || /\w+/, i.keywords && (i.keywords = oo(i.keywords, n.case_insensitive)), a.keywordPatternRe = e(l, true), o && (i.begin || (i.begin = /\B|\b/), a.beginRe = e(a.begin), !i.end && !i.endsWithParent && (i.end = /\B|\b/), i.end && (a.endRe = e(a.end)), a.terminatorEnd = Ze(a.end) || "", i.endsWithParent && o.terminatorEnd && (a.terminatorEnd += (i.end ? "|" : "") + o.terminatorEnd)), i.illegal && (a.illegalRe = e(i.illegal)), i.contains || (i.contains = []), i.contains = [].concat(...i.contains.map(function(u) {
...
function co(n) {
  return n ? n.endsWithParent || co(n.starts) : false;
}
function F9(n) {
  return n.variants && !n.cachedVariants && (n.cachedVariants = n.variants.map(function(e) {
  ...
  function d(f, b, y, T) {
    ...
    function pe() {
      ...
      if (typeof x.subLanguage == "string") {
        ...
        g = d(x.subLanguage, L, true, He[x.subLanguage]), He[x.subLanguage] = g._top;
      } else
        g = h(L, x.subLanguage.length ? x.subLanguage : null);
      x.relevance > 0 && (de += g.relevance), $.addSublanguage(g._emitter, g.language);
    }
...
var gr = U9;
function br(n) {
  let e = shallowRef(), t = n.subscribe((r) => {
    e.value = r;
  });
  return getCurrentScope() && onScopeDispose(t), e;
}
var _r;
var j9 = typeof window < "u";
...
function V9(n) {
  const e = ref(n == null ? void 0 : n.element), t = ref(n == null ? void 0 : n.input);
  function r() {
    var s, c;
  ...
  return watch([t, e], r, { immediate: true }), n != null && n.watch && watch(n.watch, r, { immediate: true, deep: true }), {
    textarea: e,
    input: t,
    triggerResize: r
  };
...
var W9 = Object.prototype.propertyIsEnumerable;
var xr = (n, e, t) => e in n ? Z9(n, e, { enumerable: true, configurable: true, writable: true, value: t }) : n[e] = t;
var Y9 = (n, e) => {
  for (var t in e || (e = {}))
...
var nP = defineComponent({
  ...
  setup(n, { emit: e }) {
    var t;
    const r = n, s = (t = r.id) != null ? t : `${+new Date()}`, c = ref("0"), i = ref(0), { textarea: o, input: a } = V9({
      onResize: l,
      watch: i
    });
    function l() {
    ...
    const d = computed(() => (u(), r.hljs.highlight(a.value, { language: r.lang }).value));
    return watchEffect(() => {
      a.value = r.code, nextTick(() => {
        ++i.value;
      });
    }), (p, h) => (openBlock(), createElementBlock("div", {
      class: "relative",
      style: normalizeStyle(`height:${c.value}`)
    }, [
      withDirectives(createBaseVNode("textarea", {
        ...
        ref_key: "textarea",
        ref: o,
        "onUpdate:modelValue": h[0] || (h[0] = (m) => isRef(a) ? a.value = m : null),
        spellcheck: "false"
      }, `
      `, 8, Q9), [
        [vModelText, unref(a)]
...
var tP = X9(nP, [["__scopeId", "data-v-646a99eb"]]);
var rP = ["viewBox"];
var oP = ["d"];
var Vn = defineComponent({
  ...
  setup(n) {
    const e = n, t = reactive({ path: "", viewbox: "" });
    function r(s) {
    ...
    }), (s, c) => (openBlock(), createElementBlock("svg", {
      xmlns: "http://www.w3.org/2000/svg",
      width: "1em",
      height: "1em",
...
var iP = { class: "code-editor" };
var aP = { key: 0 };
var lP = createTextVNode("  Execute ");
var uP = { class: "flex flex-col code-output" };
var fP = { key: 0 };
var pP = ["innerHTML"];
var hP = { key: 1 };
var dP = ["innerHTML"];
...
var _P = defineComponent({
  ...
  setup(n, { emit: e }) {
    ...
    const r = ref(""), s = ref(null), c = br(t.py.isReady), i = reactive({
      id: "",
      stdOut: new Array(),
      stdErr: new Array(),
      exception: ""
    ...
    const u = computed(() => c.value == true), d = t.py.log.listen((p) => {
      p.id == t.id && (i.id = p.id, i.stdOut = p.stdOut, i.stdErr = p.stdErr, i.exception = p.exception);
    });
    return onBeforeUnmount(() => d()), watchEffect(() => {
      r.value = t.code, s.value = "";
    }), (p, h) => (openBlock(), createElementBlock("div", null, [
      createBaseVNode("div", iP, [
        createVNode(unref(tP), {
          code: r.value,
          onKeyup: h[0] || (h[0] = withKeys(withModifiers((m) => l(), ["ctrl"]), ["enter"])),
          lang: "python",
          onEdit: h[1] || (h[1] = (m) => a(m)),
          hljs: unref(gr)
        }, null, 8, ["code", "hljs"])
      ]),
      n.controls == true ? (openBlock(), createElementBlock("div", aP, [
        createBaseVNode("button", {
          class: normalizeClass(["border code-exec-btn btn neuro", unref(u) && !unref(o) ? "cursor-pointer" : "cursor-wait"]),
          onClick: h[2] || (h[2] = (m) => l())
        }, [
          unref(u) ? (openBlock(), createElementBlock(Fragment, { key: 1 }, [
            unref(o) ? (openBlock(), createBlock(Vn, {
              key: 1,
              name: "python",
      ...
      createBaseVNode("div", uP, [
        n.stdout == true && s.value ? (openBlock(), createElementBlock("div", fP, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(i.stdOut, (m) => (openBlock(), createElementBlock("pre", { innerHTML: m }, null, 8, pP))), 256))
        ])) : createCommentVNode("", true),
        n.stderr == true ? (openBlock(), createElementBlock("div", hP, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(i.stdErr, (m) => (openBlock(), createElementBlock("pre", { innerHTML: m }, null, 8, dP))), 256))
        ])) : createCommentVNode("", true),
        n.exception == true && i.exception ? (openBlock(), createElementBlock("div", {
          key: 2,
          innerHTML: i.exception
        }, null, 8, gP)) : createCommentVNode("", true),
        n.output == true && s.value ? (openBlock(), createElementBlock("div", {
          key: 3,
          innerHTML: s.value
        }, null, 8, bP)) : createCommentVNode("", true)
      ])
    ]));
  }
});
var kr = cP(_P, [["__scopeId", "data-v-e3645984"]]);
var mP = ["innerHTML"];
...
var Me = (n) => (pushScopeId("data-v-0150d756"), n = n(), popScopeId(), n);
var vP = { class: "prosed" };
var xP = { key: 0 };
var kP = ["innerHTML"];
var yP = { class: "py-2 mt-5 w-max" };
var EP = ["innerHTML"];
var wP = { class: "mt-5 prosed" };
var AP = ["innerHTML"];
var CP = { key: 1 };
var SP = Me(() => createBaseVNode("h3", null, "Parameters", -1));
var DP = { class: "mt-3 space-y-2" };
var RP = ["innerHTML"];
var TP = createTextVNode();
var MP = ["innerHTML"];
var NP = createTextVNode(": ");
var qP = ["innerHTML"];
var LP = {
  key: 2,
  class: "mt-5"
};
var OP = Me(() => createBaseVNode("h3", null, "Returns", -1));
var IP = { class: "mt-3" };
var BP = ["innerHTML"];
var FP = {
  key: 3,
...
var $P = Me(() => createBaseVNode("h3", null, "Raises", -1));
var PP = { class: "mt-3" };
var zP = ["innerHTML"];
var HP = createTextVNode(": ");
var UP = ["innerHTML"];
var jP = {
  key: 0,
  class: "mt-5 prosed"
...
var VP = Me(() => createBaseVNode("h2", null, "Executable example", -1));
var ZP = {
  key: 1,
  class: "mt-3"
};
var KP = Me(() => createBaseVNode("h2", null, "Example", -1));
var WP = {
  key: 1,
  class: "mt-5 prosed"
};
...
var JP = Me(() => createBaseVNode("h2", null, "Executable example", -1));
var XP = {
  key: 1,
  class: "mt-3"
};
var QP = Me(() => createBaseVNode("h2", null, "Example", -1));
    ...
    return watchEffect(() => {
      ...
      return openBlock(), createElementBlock("div", null, [
        createBaseVNode("div", vP, [
          n.title ? (openBlock(), createElementBlock("h1", xP, toDisplayString(n.title), 1)) : createCommentVNode("", true),
          renderSlot(s.$slots, "default", {}, void 0, true),
          createBaseVNode("div", {
            innerHTML: n.docstring.description
          }, null, 8, kP)
        ]),
        createBaseVNode("pre", yP, [
          createBaseVNode("code", {
            innerHTML: t.value,
            style: { "white-space": "pre" }
          }, null, 8, EP)
        ]),
        createBaseVNode("div", wP, [
          n.docstring.long_description ? (openBlock(), createElementBlock("div", {
            key: 0,
            class: "mt-3",
            innerHTML: n.docstring.long_description
          }, null, 8, AP)) : createCommentVNode("", true),
          Object.keys(n.docstring.params).length > 0 ? (openBlock(), createElementBlock("div", CP, [
            SP,
            createBaseVNode("ul", DP, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(Object.keys(n.docstring.params), (a) => (openBlock(), createElementBlock("li", null, [
                createBaseVNode("kbd", {
          ...
          (o = (i = n.docstring) == null ? void 0 : i.returns) != null && o.type ? (openBlock(), createElementBlock("div", LP, [
            OP,
            createBaseVNode("div", IP, [
              createBaseVNode("span", {
                class: "hljs-built_in",
          ...
          Object.keys(n.docstring.raises).length > 0 ? (openBlock(), createElementBlock("div", FP, [
            $P,
            (openBlock(true), createElementBlock(Fragment, null, renderList(n.docstring.raises, (a) => (openBlock(), createElementBlock("div", PP, [
              createBaseVNode("span", {
                class: "hljs-built_in",
                innerHTML: a.type
              }, null, 8, zP),
        ...
        n.docstring.example ? (openBlock(), createElementBlock("div", jP, [
          n.docstring.example.is_executable ? (openBlock(), createElementBlock("div", GP, [
            VP,
            createVNode(unref(kr), {
              class: "not-prose",
              controls: true,
              id: "example_0",
              py: n.py,
          ...
          ])) : (openBlock(), createElementBlock("div", ZP, [
            KP,
            createVNode(yr, {
        ...
        n.docstring.extra_examples ? (openBlock(), createElementBlock("div", WP, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(n.docstring.extra_examples, (a) => (openBlock(), createElementBlock("div", null, [
            a.is_executable ? (openBlock(), createElementBlock("div", YP, [
              JP,
              createVNode(unref(kr), {
                class: "not-prose",
                controls: true,
            ...
            ])) : (openBlock(), createElementBlock("div", XP, [
              QP,
              createVNode(yr, {
                class: "static-code not-prose",
                code: a.code
...
var n7 = Sr(e7, [["__scopeId", "data-v-0150d756"]]);
function t7(n) {
  const e = n.regex, t = {}, r = {
    begin: /\$\{/,
    end: /\}/,
...
var Zn = defineComponent({
  ...
  setup(n) {
    return ge.registerLanguage("python", ln), ge.registerLanguage("typescript", o7), ge.registerLanguage("bash", t7), (e, t) => (openBlock(), createElementBlock("div", s7, [
      createVNode(e4, {
        source: n.code,
        hljs: unref(ge)
      }, null, 8, ["source", "hljs"])
...
var d7 = defineComponent({
  ...
  setup(n) {
    const e = n, t = reactive({ data: {} }), r = ref(false);
    return watchEffect(async () => {
      r.value = false, t.data = await e.nav.loadFromRoutePath(e.url), r.value = true;
    }), (s, c) => {
      var i;
      return r.value ? (openBlock(), createElementBlock("div", c7, [
        t.data.hasDocstring === true ? (openBlock(), createBlock(n7, {
          key: 0,
          py: n.py,
          class: "max-w-[105ch]",
          ...
          default: withCtx(() => {
            var o;
            return [
              (o = t.data.docstring.extra_md) != null && o.header ? (openBlock(), createBlock(Zn, {
                key: 0,
                code: t.data.docstring.extra_md.header,
                class: normalizeClass(t.data.hasDocstring ? "mb-3" : "")
              }, null, 8, ["code", "class"])) : createCommentVNode("", true)
            ];
          }),
          _: 1
        }, 8, ["py", "docstring", "title"])) : createCommentVNode("", true),
        (i = t.data.docstring) != null && i.extra_md ? (openBlock(), createBlock(Zn, {
          key: 1,
          code: t.data.docstring.extra_md.footer,
          class: normalizeClass(t.data.hasDocstring ? "mt-5" : "")
        }, null, 8, ["code", "class"])) : createCommentVNode("", true),
        t.data.hasMarkdown ? (openBlock(), createBlock(Zn, {
          key: 2,
...
//# sourceMappingURL=@docdundee_vue.js.map
